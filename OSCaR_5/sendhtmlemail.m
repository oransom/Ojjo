function sendhtmlemail(to,subject,theMessage,attachments)
...
% sendmail not supported in MATLAB clients which are not local such as MATLAB Online
import matlab.internal.lang.capability.Capability %this is 2023
Capability.require([Capability.LocalClient]);

% import matlab.internal.capability.Capability %this is 2024a
% Capability.require([Capability.LocalClient]);
